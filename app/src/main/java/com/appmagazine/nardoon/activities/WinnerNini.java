...
import com.appmagazine.nardoon.Adapter.WinnerNiniAdapter;
...
public class WinnerNini extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_winner_nini);
        ...
        appbarTitle.setText("نی نی عکس های برتر");
        ...
        array = new ArrayList<>();
        adapter = new WinnerNiniAdapter(App.context, array);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    for (int i = 0; i < posters.length(); i++) {
                        if (( Arrays.asList(posters.getJSONObject(i).getString("validity")).contains("20")) ||( Arrays.asList(posters.getJSONObject(i).getString("validity")).contains("10"))){
